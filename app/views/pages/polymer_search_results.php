<?php
    ...
    //Could never get the pagination to work properly with the results page.
    //This page could also be way more functional if the search options where also added 
    //to this page.
    ...
    ?>
        <!--<div class="table-container" data-bs-spy="scroll" data-bs-offset="0" tabindex="0">-->
            <?php 
                ...
                echo "Hello";
                //This checks for the submission button to be triggered. Subit search is for keyword search.
                if (isset($_POST['submit-search'])){
                    ...
                    //This is the ugliest search I have ever done and should be optomized to look nicer.
                    //The problem with not using the union all feature is that it would search the same tables multiple
                    //times in order to find the likeness which resulted in more results than were even in the db.
                    $sql = "SELECT*
                    ...
                    //This is just some text to display the amount of results.
                    echo "<p class='text-center'>
                            There are ".$queryResults." result(s).
                        </p>";

                    //This is uses nested html to display the db content.
                    if($queryResults > 0) {
                ...
                //This is checkig if the user is using the multi search instead.d
