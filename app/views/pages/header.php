<?php
//Each page needs the session start function in order to use session variables.
    session_start();
    //This is allowing all of the pages to have a clear connection to the server.
...
<html lang="en">
    <head>
        ...
        <!-- 
            ...
            Date: 9/19/2022
            References: HTML5 and CSS3 Illustrated, W3 Schools, Stack Overflow.
        -->
        <!--This is just all of the standard meta information(user agent) and the appropriate scripts for 
    using bootstrap, JQuery, and etc..-->
        <meta charset="utf-8">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="top" style="background-color: #000000;" style="border-bottom: 1px solid #333333;">
            ...
            <div class="collapse navbar-collapse" id="myNavbarToggler7">
                <ul class="navbar-nav mx-auto">
                    ...
                    <?php
                        //Run conditionals to display certain hyperlinks if the user is signed in.
